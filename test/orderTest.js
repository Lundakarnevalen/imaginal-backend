    ...
    it('Authorized getOrdersOnSection, role: warehouseWorker', done => {
      api.get('/api/warehouse/order/location/list/1')
        ...
        .end(async (err, res) => {
          ...
          await expect(res.statusCode).to.equal(200)
          await expect(res.body.data[0].Items[0].OrderLines.quantityDelivered).to.equal(15)
          done()
        })
    })
    ...
    it('Unauthorized getOrdersOnSection, role: warehouseManager', done => {
      api.get('/api/warehouse/order/location/list/1')
        ...
        .end(async (err, res) => {
          ...
          await expect(res.statusCode).to.equal(200)
          await expect(res.body.data[0].id).to.equal(1)
          await expect(res.body.data[0].Items[0].OrderLines.quantityDelivered).to.equal(20)
          done()
        })
    })
    ...
    it('Unauthorized getOrdersOnSection, role: admin', done => {
      api.get('/api/warehouse/order/location/list/1')
        ...
        .end(async (err, res) => {
          ...
          await expect(res.statusCode).to.equal(200)
          await expect(res.body.data[0].id).to.equal(1)
          await expect(res.body.data[0].Items[0].OrderLines.quantityDelivered).to.equal(25)
          done()
        })
    })

    it('Authorized createReturn, role: warehouseWorker', done => {
